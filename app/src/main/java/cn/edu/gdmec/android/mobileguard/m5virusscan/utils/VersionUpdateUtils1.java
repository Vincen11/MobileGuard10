...
import cn.edu.gdmec.android.mobileguard.m5virusscan.entity.VersionEntity1;

/**
 * Created by Jack on 2017/10/12.
 */

public class VersionUpdateUtils1{
    private String mVersion;
    private Activity context;
    private VersionEntity1 versionEntity;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MESSAGE_ENTERHOME:
                    Intent intent = new Intent(context, VirusScanActicity.class);
    ...
    public VersionUpdateUtils1(String mVersion, Activity context) {
    ...
    public void getCloudVersion() {
        try {
            ...
            if (execute.getStatusLine().getStatusCode() == 200) {
                ...
                versionEntity = new VersionEntity1();
    ...
    private void showUpdateDialog(final VersionEntity1 versionEntity) {
    ...
    private void downloadNewApk(String apkurl) {
        DownloadUtils1 downloadUtils = new DownloadUtils1();
