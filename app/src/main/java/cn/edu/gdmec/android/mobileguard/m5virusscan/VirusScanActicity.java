...
public class VirusScanActicity extends AppCompatActivity implements View.OnClickListener {
    ...
    Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 0){
                AntiVirusDao dao = new AntiVirusDao(VirusScanActicity.this);
                String dbVersion = dao.getVirusDbVersion();
                mDbVersionTV = (TextView) findViewById(R.id.tv_virusversion);
    ...
    final private void UpdateDb(String localDbVersion){
        final VersionUpdateUtils versionUpdateUtils = new VersionUpdateUtils(localDbVersion,VirusScanActicity.this,downloadCallback,null);
        new Thread(){
