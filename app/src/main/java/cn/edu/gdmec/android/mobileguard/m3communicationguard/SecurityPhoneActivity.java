...
public class SecurityPhoneActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private FrameLayout mHaveBlackNumber;//有黑名单的布局
    private FrameLayout mNoBlackNumber;//没有黑名单的布局
    ...
    private void fillData(){
        ...
        if (totalNumber==0){
            ...
            pagenumber=0;
            if (pageBlackNumber.size()>10){
                pageBlackNumber.clear();
            }
          pagesize=totalNumber;//老师的坑在这里解决了 总数=pasesize
    ...
    private void initView(){
        ...
        mListView.setOnScrollListener(new AbsListView.OnScrollListener(){
            ...
            public void onScrollStateChanged(AbsListView absListView, int i) {
               ...
               //     case AbsListView.OnScrollListener.SCROLL_STATE_TOUCH_SCROLL://手指正拖着滑动
                    case AbsListView.OnScrollListener.SCROLL_STATE_FLING://列表自由滑动
                        //获取最后一个可见条目
