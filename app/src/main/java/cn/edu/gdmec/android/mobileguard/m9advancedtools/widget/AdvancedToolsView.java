...
public class AdvancedToolsView extends RelativeLayout {
    ...
    public AdvancedToolsView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs,R.styleable.AdvancedToolView);
        desc = mTypedArray.getString(R.styleable.AdvancedToolView_desc);
        drawable = mTypedArray.getDrawable(R.styleable.AdvancedToolView_android_src);
        mTypedArray.recycle();
        init(context);
    }
