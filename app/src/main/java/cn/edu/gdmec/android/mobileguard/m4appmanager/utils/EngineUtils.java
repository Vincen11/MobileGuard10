...
//            }
    ...
    //获取活动包名
    public static void ActicityApplication(Context context, AppInfo appInfo) {

        PackageManager pm1 = context.getPackageManager();
        StringBuffer sb  = new StringBuffer();
        ActivityInfo act[] = pm1.getPackageArchiveInfo(appInfo.apkPath, PackageManager.GET_ACTIVITIES).activities;//quanxian
